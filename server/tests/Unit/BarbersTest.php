...
class StudentTest extends TestCase
{
    ...
    public function test_exists_barbers_table(): void
    {
    ...
    public function test_does_the_barbers_table_contain_all_fields(string $expectedColumn, string $expectedType): void
    {
    ...
    #[DataProvider('expectedSchemaDataProvider')]
    public function test_the_barbers_table_columns_have_the_expected_types($expectedColumn, $expectedType)
    {
